...
const About = () => {
  const paragraphs=[
    {title:" Achievements",
    subtile:"Celebrating a Career of Excellence",
  ...
  return (
    <>
      ...
      <div className="">
         <h2 className=" underline underline-offset-8 text-blue-500 decoration-slate-300  text-dark mb-2 text-4xl font-semibold dark:text-white text-center">
         About Us
         </h2>
      </div>
        <div className="container mx-auto px-[7.5rem]">
          <div className="flex flex-wrap items-center justify-between -mx-4">
              ...
              <div className="flex items-center -mx-3 sm:-mx-4">
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="py-3 sm:py-4">
                    <img
                    data-aos="flip-right"
                      src="https://images.unsplash.com/photo-1569016832321-084c128adeb8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGpvdXJuYWxpc3R8ZW58MHx8MHx8fDA%3D"
                      alt=""
                  ...
                  <div className="py-3 sm:py-4">
                    <img
                    data-aos="flip-right"
                      src="https://img.freepik.com/free-vector/realistic-world-press-freedom-day-illustration_23-2148902787.jpg?size=626&ext=jpg&ga=GA1.1.481449724.1699438456&semt=sph"
                      alt=""
                      className="w-full rounded-2xl"
                    />
                  </div>
                ...
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="relative z-10 my-4">
                    <img
                    data-aos="flip-right"
                      src="https://img.freepik.com/premium-photo/journalist-illustration_1003030-16983.jpg?size=626&ext=jpg&ga=GA1.1.481449724.1699438456&semt=sph"
                      alt=""
                      className="w-full rounded-2xl"
                    />
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12"  data-aos-duration="500" data-aos="fade-left">
              <div className="mt-10 lg:mt-0">
                ...
                <strong>Mr. Arun</strong>, a recently retired journalist, has spent his career traversing the dynamic landscape of journalism. His relentless pursuit of truth and passion for storytelling have led him to cover a wide array of topics, from local news to international affairs. Now, he’s ready to share his wealth of knowledge and experiences with you. its write extra information for dummyt information
                </p>
          ...
          <section class=" bg-white pt-12 text-gray-800">
