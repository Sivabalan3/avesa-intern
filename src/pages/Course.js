...
dataaostime:"1000",},
{
  ...
  <div className="mx-auto mt-20 mb-16 block px-6 text-center" data-aos="fade-up"
     data-aos-easing="linear"
     data-aos-duration="2000">
    <h2 className=" underline underline-offset-8 text-blue-500 decoration-slate-300  text-dark mb-2 text-4xl font-semibold dark:text-white text-center">Course Overview</h2>
  ...
  <div className="grid gap-10 pb-20 sm:grid-cols-2 lg:grid-cols-2">
    {coursesDetails.map((items)=>(
      ...
      <div className="my-4 flex items-center ">
        ...
        <h3 className="text-xl font-light leading-10 text-slate-700 md:text-2xl ">{items.title}</h3>
      </div>
  ...
  <div className="max-w-4xl mx-auto px-5 mt-16" >
    ...
    <div className="text-center" data-aos="fade-down"> 
        <h2 className=" underline underline-offset-8 text-blue-500 decoration-slate-300  text-dark mb-2 text-4xl font-semibold dark:text-white text-center">Why Choose to Us Course</h2>
        <p className="max-w-md mx-auto mt-2 text-gray-500 text-lg font-normal leading-9">This course is not just about learning, it’s about experiencing the world of journalism firsthand. You’ll get a chance to interact with Mr. Arun, ask questions, and even get feedback on your work. Plus, you’ll be joining a community of like-minded individuals who share your passion for journalism. its serated this paragrap in points</p>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-10 mt-10">
        {whyChooseCourse.map((course)=>(
            ...
            <div>
                <h3 className="text-xl font-light md:text-2xl text-slate-700">{course.Title}</h3>
